            ...
            <div className="row g-4 mb-5">
              {addresses.map(address => (
                <div key={address.id} className="col-lg-6">
                  <label className="w-100 d-block cursor-pointer">
                    {/* Address Card */}
                    <div 
                      className={`card address-card shadow-sm p-4 h-100 ${
                        isCheckoutFlow && selectedAddressId === address.id ? 'border-primary border-2 bg-light' : ''
                      }`}
                      style={{ cursor: isCheckoutFlow ? 'pointer' : 'default', transition: 'all 0.2s' }}
                      onClick={() => {
                        if (isCheckoutFlow) {
                    ...
                    >
                      <div className="d-flex justify-content-between align-items-start">
                        <div className="d-flex align-items-center gap-2">
                           ...
                           <h5 className="mb-0 fw-bold">{address.name}</h5>
                        </div>
                        {address.isDefault && (
