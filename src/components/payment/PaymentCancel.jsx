    ...
    return (
        <div style={styles.container}>
            <div style={styles.card} className="animation-fade-in">
                ...
                <h1 className="h3 mb-3 fw-bold text-dark">Payment Cancelled</h1>
                
                <p className="text-muted mb-4 fs-6">
                    Your payment was not completed or you cancelled the checkout process. Your cart items are still saved.
                </p>
                ...
                >
                    <i className="fa fa-shopping-cart me-2"></i> Return to Cart
                </Link>
                
                <Link to="/products" className="d-block mt-3 text-secondary small text-decoration-none hover-brand transition-colors">
                    Continue Browsing
                </Link>
            </div>
            <style>{`
